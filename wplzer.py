...
class Wappalyzer:
    ...
    def get_versions(self, app_name):
        ...
        """
        return None if 'versions' not in self.technologies[app_name] else self.technologies[app_name]['versions']
    ...
    def analyze_with_versions(self, webpage):
        ...
        for app_name in detected_apps:
            ...
            versioned_apps[app_name] = {"appname":app_name,"versions": versions}
